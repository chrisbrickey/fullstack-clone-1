...
ActiveRecord::Base.transaction do
  ...
  demo3 = User.create!(name: 'Chris Brickey', username: 'twototango', password: '123456', profile_img_url: 'https://res.cloudinary.com/dckkkjkuz/image/upload/v1503460927/abstract_o0yek5.jpg', tagline: 'Be strong, be fearless, be beautiful. - Misty Copeland')
  ...
  demo5 = User.create!(name: 'Chris Brickey', username: 'attitude', password: '123456', profile_img_url: 'https://res.cloudinary.com/dckkkjkuz/image/upload/v1503460942/sneaker_ilnzay.jpg', tagline: 'Work transforms talent into genius. - Anna Pavlova')
