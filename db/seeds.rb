...
ActiveRecord::Base.transaction do
  ...
  likeX = Like.create!(user_id: demo5.id, likable_id: photo1.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo2.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo3.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo4.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo5.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo6.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo8.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo10.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo12.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo5.id, likable_id: photo14.id, likable_type: 'Photo')

  likeX = Like.create!(user_id: demo4.id, likable_id: photo1.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo2.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo3.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo4.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo5.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo6.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo9.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo12.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo15.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo4.id, likable_id: photo18.id, likable_type: 'Photo')

  likeX = Like.create!(user_id: demo3.id, likable_id: photo1.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo3.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo5.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo7.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo11.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo15.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo19.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo23.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo24.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo3.id, likable_id: photo18.id, likable_type: 'Photo')

  likeX = Like.create!(user_id: demo2.id, likable_id: photo2.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photo4.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photo8.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photo10.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo2.id, likable_id: photoX.id, likable_type: 'Photo')
  ...
  likeX = Like.create!(user_id: demo1.id, likable_id: photo2.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo1.id, likable_id: photo3.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo1.id, likable_id: photo4.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo1.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo1.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo1.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo1.id, likable_id: photoX.id, likable_type: 'Photo')
  likeX = Like.create!(user_id: demo1.id, likable_id: photoX.id, likable_type: 'Photo')
